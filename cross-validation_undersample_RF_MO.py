...
for i in projects:
    ...
    plt.savefig('./result/FirstPaper_CrossValidation_RF_MO_' + i + getCurrentDateTime() + '.jpg', dpi=300, bbox_inches='tight')

# generate excel file
filename = './result/FirstPaper_CrossValidation_RF_MO_' + getCurrentDateTime() + '.xls'
