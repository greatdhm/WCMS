...
for i in projects:
    ...
    scores = cross_val_score(xgb, X, y, scoring='neg_mean_squared_error', cv=kf)
    ...
    plt.savefig('./result/FirstPaper_CrossValidation_XGB_MO_' + i + getCurrentDateTime() + '.jpg', dpi=300, bbox_inches='tight')

# generate excel file
filename = './result/FirstPaper_CrossValidation_XGB_MO_' + getCurrentDateTime() + '.xls'
