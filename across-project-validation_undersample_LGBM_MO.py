    ...
    for i2 in test_projects:
        if i1 == i2:
            ...
            space = [Integer(10, 300, name='n_estimators'),
                     ...
                     Real(0, 1, name='feature_fraction'),
            ...
            def objective(**params):
                ...
                print('Train project:%s is optimizing. Test project:%s, Acc: %s, Popt: %s' % (i1, i2, roi[1], popt))
            ...
            MaxIter = 500
            dim = 8
            lb = np.array([10, 5, 20, 10, 0.01, 0, 0, 0])
            ...
            plt.savefig('./result/FirstPaper_AcrossProject_Validation_lgbm_' + i1 + '_' + i2 + getCurrentDateTime() + '.jpg', dpi=300, bbox_inches='tight')

# generate excel file
filename = './result/FirstPaper_AcrossProject_Validation_LGBM_MO_' + getCurrentDateTime() + '.xls'
